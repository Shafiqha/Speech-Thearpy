"""
Clean and recreate tables - drop existing tables and recreate them
"""
...
print("=" * 70)
print("🧹 CLEANING AND RECREATING TABLES")
print("=" * 70)
...
try:
    ...
    tables_to_drop = [
        'lip_animation_attempts',
        'lip_animation_exercises',
        'clinician_notes',
        'assessment_results',
    ...
    print("\n" + "=" * 70)
    print("✅ TABLES CLEANED AND RECREATED!")
    print("=" * 70)
    print("\n🚀 Next Steps:")
